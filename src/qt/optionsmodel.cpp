...
void OptionsModel::Init()
{
    ...
    if (!settings.contains("nAnonymizeYuanCoinAmount"))
        settings.setValue("nAnonymizeYuanCoinAmount", 1000);
    nAnonymizeYuanCoinAmount = settings.value("nAnonymizeYuanCoinAmount").toLongLong();
    if (settings.contains("nDarksendRounds"))
        SoftSetArg("-darksendrounds", settings.value("nDarksendRounds").toString().toStdString());
    if (settings.contains("nAnonymizeYuanCoinAmount"))
        SoftSetArg("-anonymizetraveamount", settings.value("nAnonymizeYuanCoinAmount").toString().toStdString());
...
QVariant OptionsModel::data(const QModelIndex & index, int role) const
{
    if(role == Qt::EditRole)
    {
        ...
        case AnonymizeYuanCoinAmount:
            return QVariant(nAnonymizeYuanCoinAmount);
        case UseBlackTheme:
...
bool OptionsModel::setData(const QModelIndex & index, const QVariant & value, int role)
{
    ...
    if(role == Qt::EditRole)
    {
        ...
        case DarksendRounds:
            ...
            break;
        case AnonymizeYuanCoinAmount:
            nAnonymizeYuanCoinAmount = value.toInt();
            settings.setValue("nAnonymizeYuanCoinAmount", nAnonymizeYuanCoinAmount);
            emit AnonymizeYuanCoinAmountChanged(nAnonymizeYuanCoinAmount);
            break;
        default:
            break;
        }
