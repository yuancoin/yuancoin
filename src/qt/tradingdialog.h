...
private slots:
    ...
    QString BuyYUANC(QString OrderType, double Quantity, double Rate);
    QString SellYUANC(QString OrderType, double Quantity, double Rate);
