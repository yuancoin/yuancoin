...
#define START_MASTERNODE_PAYMENTS_TESTNET 1533715688// 2018-8-08 08:08:08 GMT
#define START_MASTERNODE_PAYMENTS 1533715688 // 2018-08-08 08:08:08 GMT

static const int64_t DARKSEND_COLLATERAL = (0.1*COIN);
static const int64_t DARKSEND_POOL_MAX = (4999.99*COIN);

static const int64_t STATIC_POS_REWARD = 8 * COIN; //Constant reward of 8 YUANC per COIN i.e. 8%
...
inline int64_t GetMNCollateral(int nHeight) { return 400000; }
