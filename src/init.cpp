...
std::string HelpMessage()
{
    ...
    strUsage += "  -conf=<file>           " + _("Specify configuration file (default: YuanCoin.conf)") + "\n";
    strUsage += "  -pid=<file>            " + _("Specify pid file (default: YuanCoind.pid)") + "\n";
...
strUsage += "\n" + _("Masternode options:") + "\n";
    ...
    strUsage += "  -anonymizeYuanCoinamount=<n> " + _("Keep N YuanCoin anonymized (default: 0)") + "\n";
...
#define PROCESS_DEP_ENABLE 0x00000001
    ...
    if (!lock.try_lock())
        return InitError(strprintf(_("Cannot obtain a lock on data directory %s. YuanCoin is probably already running."), strDataDir));

    if (GetBoolArg("-shrinkdebugfile", !fDebug))
        ShrinkDebugFile();
    LogPrintf("\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n\n");
    LogPrintf("YuanCoin version %s (%s)\n", FormatFullVersion(), CLIENT_DATE);
    ...
    nAnonymizeYuanCoinAmount = GetArg("-anonymizeYuanCoinamount", 0);
    if(nAnonymizeYuanCoinAmount > 999999) nAnonymizeYuanCoinAmount = 999999;
    if(nAnonymizeYuanCoinAmount < 2) nAnonymizeYuanCoinAmount = 2;
    ...
    LogPrintf("Anonymize YuanCoin Amount %d\n", nAnonymizeYuanCoinAmount);

    /* Denominations
       A note about convertability. Within Darksend pools, each denomination
       is convertable to another.
       For example:
       1YUANC+1000 == (.1YUANC+100)*10
       10YUANC+10000 == (1YUANC+1000)*10
    */
